...
- [Targets](#targets)
- [Editor setup](#editor)
- [Development authentication](#auth-during-development)
- [Adding dependencies](#adding-dependencies)

### Development workflow
- [Development loop](#dev-loop)
- [Logging](#logging)
- [Pre-commit verification](#verification-run-before-every-commit--pr)

### Continuous integration
- [Self-hosted CI setup](#testing)

### Release workflow
- [Building a release](#building-for-release)
- [Publishing a release](#releasing)
...
<a id="auth-during-development"></a>
...
<a id="verification-run-before-every-commit--pr"></a>
