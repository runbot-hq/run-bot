...
- ⚡️ **Caller-agnostic concurrency** — every transport method is `@concurrent`; no main-thread hops, no actor bottlenecks. Call from any actor without blocking the UI
